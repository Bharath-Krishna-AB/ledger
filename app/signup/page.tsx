        ...
        <div className="min-h-screen bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md z-10">
                ...
                <p className="mt-2 text-center text-sm text-gray-800 font-space font-bold tracking-tight uppercase">
                    Start mastering your finances today in less than a minute.
                </p>
            </div>
                ...
                <div className="bg-white py-10 px-6 shadow-brutal-lg border-4 border-black sm:px-10">
                    ...
                    <form className="space-y-6" action={signup}>
                        ...
                        <div className="flex items-center">
                            ...
                            />
                            <label htmlFor="agree-terms" className="ml-2 block text-xs font-space font-bold uppercase text-black tracking-tight cursor-pointer">
                                I agree to the <a href="#" className="underline text-black font-bold hover:text-accent border-b-2 border-black hover:border-accent">Terms</a> and <a href="#" className="underline text-black font-bold hover:text-accent border-b-2 border-black hover:border-accent">Privacy Policy</a>
                            </label>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                Sign Up <UserPlus className="w-5 h-5 border-2 border-black rounded-sm shadow-brutal bg-white text-black p-0.5" />
                            </button>
                        </div>
                    </form>
                    ...
                    <div className="mt-8 text-center border-t-2 border-black pt-6">
                        <p className="text-xs font-space font-bold uppercase text-gray-600 tracking-tight">
                            ...
                            <Link href="/login" className="font-bold text-black border-b-2 border-black hover:text-accent hover:border-accent transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
