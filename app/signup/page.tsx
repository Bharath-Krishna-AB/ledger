            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md z-10 px-4">
                ...
                <div className="bg-white/80 backdrop-blur-xl border border-white shadow-soft-lg rounded-[40px] p-8 sm:p-10 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-8 pointer-events-none opacity-[0.03]">
                        <UserPlus className="w-32 h-32 text-black rotate-12" />
                    </div>
                    ...
                    <form className="space-y-5" action={signup}>
                        ...
                        <div className="flex items-start px-1 pt-1">
                            ...
                            <div className="ml-3 text-xs">
                                <label htmlFor="agree-terms" className="font-semibold text-gray-500 cursor-pointer">
                                    I agree to the <a href="#" className="text-black font-bold hover:text-primary transition-colors">Terms</a> and <a href="#" className="text-black font-bold hover:text-primary transition-colors">Privacy Policy</a>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="pt-2">
                            ...
                            >
                                ...
                                <CheckCircle2 className="w-5 h-5 relative z-10 transition-transform group-hover:scale-110" />
                    ...
                    <div className="mt-8 text-center bg-gray-50/50 -mx-10 -mb-10 p-6 border-t border-gray-100">
                        <p className="text-xs font-semibold text-gray-500">
                            ...
                            <Link href="/login" className="text-black font-bold hover:text-primary transition-colors hover:underline underline-offset-4 decoration-black/10">
                                Sign In
                            </Link>
                        </p>
                    </div>
